namespace SaltyShared
{
    public static class Event
    {
        ...
        public const string SaltyChat_MicEnabledChanged = nameof(SaltyChat_MicEnabledChanged);
        public const string SaltyChat_SoundStateChanged = nameof(SaltyChat_SoundStateChanged);
        public const string SaltyChat_SoundEnabledChanged = nameof(SaltyChat_SoundEnabledChanged);
        #endregion
